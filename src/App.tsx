...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-[#09090b] dark:text-[#fafafa] relative overflow-x-hidden selection:bg-indigo-500/20 selection:text-indigo-900 dark:selection:bg-indigo-500/30 dark:selection:text-indigo-200 transition-colors duration-300">
      ...
      {/* Navigation Bar */}
      <header className="fixed top-0 left-0 right-0 z-50 py-3 sm:py-4 portfolio-navbar">
      ...
      <main className="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto pt-28 sm:pt-32 pb-12">
        ...
        <section
          id="home"
          className="relative pt-4 pb-16 sm:pb-24 overflow-hidden"
        >
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[560px] lg:min-h-[620px] relative">
            ...
            >
              ...
              <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-[42px] font-bold text-slate-900 dark:text-white leading-[1.18] tracking-tight mb-6">
                Aqib is solving problems through strategic design and compelling
                visuals
              </h1>
            ...
            >
              <p className="text-sm sm:text-base text-slate-600 dark:text-zinc-300 leading-relaxed mb-8">
                As a digital product designer and full-stack engineer with a
                strong focus on visual design, performant web applications, and
                Framer/Next.js platforms, he collaborates closely with founders
                and teams to craft seamless, user-centered experiences. A
            ...
            {[
              {
                ...
                val: "99/100",
                desc: "Zero layout shift, instant TTI",
              },
              {
                label: "Client Lead Velocity",
                val: "3.2x",
                desc: "Measurable conversion lift",
              },
              {
                label: "Engineering Stack",
                val: "Next.js 15",
                desc: "React 19 + TypeScript + Tailwind",
              },
              {
                label: "Client Satisfaction",
                val: "100%",
                desc: "Bespoke design, zero template slop",
              },
            ].map((stat, i) => (
              <div
                key={i}
                className="p-4 sm:p-5 rounded-2xl glass-card border border-slate-200/80 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10 transition-colors"
              >
        ...
        <section
          id="work"
          className="py-20 sm:py-28 border-t border-slate-200/80 dark:border-white/5 content-auto"
        >
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-4">
            ...
            <p className="text-slate-600 dark:text-zinc-400 text-sm sm:text-base max-w-md">
              Every project is custom architected from zero: bespoke brand
              identity, fluid micro-interactions, and blazing performance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {PROJECTS.map((proj) => {
              const IconComponent =
                proj.id === "kuro-omakase"
                  ? UtensilsCrossed
                  : proj.id === "vanguard-dallas"
                    ? Building2
                    : proj.id === "maison-co"
                      ? Flame
                      : Coffee;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <p className="text-slate-600 dark:text-zinc-400 text-sm sm:text-base leading-relaxed">
                Most websites look like generic templates or crawl under bloated
                dependencies. I build at the exact intersection of high-tier
                aesthetic design and clean, scalable code.
              </p>

              <div className="space-y-3 pt-2">
                {[
                  {
                    title: "Full Brand Alignment",
                    desc: "Every line of styling reinforces your luxury, authority, or SaaS identity.",
                  },
                  {
                    title: "Lighthouse 95+ Standard",
                    desc: "Zero layout shift (CLS < 0.05), responsive image pipelines, edge CDN ready.",
                  },
                  {
                    title: "Interactive Revenue Engines",
                    desc: "Dynamic price calculators, reservation calendars, and custom quizzes.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex items-start gap-3 p-3.5 rounded-xl glass-card border border-slate-200/80 dark:border-white/5"
                  >
                    <CheckCircle2 className="w-5 h-5 text-[#E2B872] shrink-0 mt-0.5" />
                    <div>
                      <div className="text-xs sm:text-sm font-semibold text-slate-900 dark:text-zinc-200">
                        {item.title}
                      </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {SKILL_CATEGORIES.map((cat, i) => (
                <div
                  key={i}
                  className="p-5 rounded-2xl glass-card border border-slate-200/80 dark:border-white/10 hover:border-amber-400/40 dark:hover:border-amber-500/20 transition-all flex flex-col justify-between"
                >
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {cat.skills.map((skill, si) => (
                        <span
                          key={si}
                          className="text-xs px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-white/5 text-slate-700 dark:text-zinc-300 border border-slate-200/80 dark:border-white/5"
                        >
                          {skill}
                        </span>
                      ))}
        ...
        >
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-slate-600 dark:text-zinc-400 text-sm sm:text-base">
              A structured, transparent delivery pipeline with zero fluff, rapid
              iterations, and relentless attention to detail.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {WORK_PROCESS.map((proc, i) => (
              <div
                key={i}
                className="p-6 rounded-2xl glass-card border border-slate-200/80 dark:border-white/10 relative flex flex-col justify-between hover:border-slate-300 dark:hover:border-white/20 transition-colors"
              >
                <div>
                  <div className="font-mono text-3xl font-extrabold text-[#E2B872]/30 mb-4">
                    {proc.step}
                  </div>
        ...
        <section
          id="contact"
          className="py-16 sm:py-20 border-t border-slate-200/80 dark:border-white/5 content-auto"
        >
              ...
              <div className="md:col-span-5 space-y-6 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-slate-600 dark:text-zinc-400 text-xs sm:text-sm leading-relaxed mb-6">
                    Tell me about your product vision, timeline, or redesign
                    requirements. I typically reply within 12 hours with a clear
                ...
                {formSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-slate-700 dark:text-zinc-300 text-sm max-w-sm mb-6">
                      Thank you for reaching out, {formData.name}. I'll review
                      your project details and get back to you shortly at{" "}
                      <span className="text-[#E2B872] font-mono font-medium">
                        {formData.email}
                      </span>
                      .
                    </p>
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-4">
                    <div>
                      <label className="block text-xs font-mono text-slate-600 dark:text-zinc-400 mb-1.5 font-semibold dark:font-normal">
                        YOUR NAME
                      </label>
                      <input
                        type="text"
      ...
      <footer className="border-t border-slate-200 dark:border-white/10 py-8 px-4 max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500 dark:text-zinc-500">
        <div className="flex items-center gap-2">
          ...
          <span>
            © {new Date().getFullYear()} Aqib Munir. Built with passion.
          </span>
        </div>
        ...
        <div className="flex items-center gap-6">
          <a
            href="#home"
            className="hover:text-slate-900 dark:hover:text-zinc-300 transition-colors"
          >
            Back to Top
          </a>
          <a
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-sm text-slate-700 dark:text-zinc-300 leading-relaxed">
                  <div>
                    <h4 className="text-xs font-mono text-[#E2B872] uppercase tracking-wider mb-1 font-semibold dark:font-normal">
                      THE OVERVIEW
                    </h4>
                  ...
                  <div>
                    <h4 className="text-xs font-mono text-emerald-600 dark:text-emerald-400 uppercase tracking-wider mb-2 font-semibold dark:font-normal">
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {selectedProject.features.map((feat, i) => (
                        <li
                          key={i}
                          className="flex items-start gap-2 text-xs text-slate-700 dark:text-zinc-300 bg-slate-100 dark:bg-white/5 p-2.5 rounded-lg"
                        >
                  ...
                  <div>
                    <h4 className="text-xs font-mono text-amber-600 dark:text-amber-400 uppercase tracking-wider mb-1 font-semibold dark:font-normal">
                      ARCHITECTURE & PERFORMANCE
                    </h4>
                    <p className="text-xs text-slate-600 dark:text-zinc-400">
                      {selectedProject.keyArchitecture}
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-slate-200 dark:border-white/10 flex flex-wrap items-center justify-between gap-4">
                  <div className="flex flex-wrap gap-1.5">
                    {selectedProject.tags.map((t, i) => (
                      <span
                        key={i}
                        className="text-[11px] font-mono px-2 py-1 rounded bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-zinc-400 border border-slate-200/60 dark:border-transparent"
                      >
                        {t}
                      </span>
                    ))}
