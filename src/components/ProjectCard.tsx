...
export function ProjectCard({ project, onOpenModal, icon: IconComponent }: ProjectCardProps) {
  ...
  return (
    <div
      ...
      className="group relative rounded-3xl glass-card border border-slate-200/80 dark:border-white/10 hover:border-indigo-500/40 p-6 sm:p-7 flex flex-col justify-between cursor-pointer transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-500/10 dark:hover:shadow-indigo-500/15 hover:-translate-y-1 overflow-hidden"
    >
      ...
      <div>
        ...
        <div className="relative w-full h-52 sm:h-60 mb-6 rounded-2xl overflow-hidden bg-slate-100 dark:bg-[#0e0e14] border border-slate-200 dark:border-white/10 group-hover:border-indigo-400/40 dark:group-hover:border-white/20 transition-all">
